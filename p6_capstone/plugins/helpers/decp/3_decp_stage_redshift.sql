...
FROM staging.staging_decp_titulaires
WHERE
...
TRUNCATE  staging.decp_titulaires_formatted;

INSERT INTO  staging.decp_titulaires_formatted
SELECT
       decp_uid,
       CASE
...
TRUNCATE table reporting.decp_marches;

INSERT INTO reporting.decp_marches
SELECT *
FROM staging.staging_decp_marches;

TRUNCATE reporting.decp_awarded;
INSERT INTO reporting.decp_awarded
SELECT decp_uid, eu_vat, siren, siret, titulaire_name, LEFT(eu_vat, 2) as countrycode
FROM staging.decp_titulaires_formatted;
